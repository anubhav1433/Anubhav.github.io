        ...
        <div className="text-center">
            ...
            <div>
                <div className=" mb-9 flex w-full justify-center ">
                    ...
                    <a href="https://www.linkedin.com/in/anubhav-mendhiratta/" className="mr-9 text-blue-800 hover:translate-y-[-10px]">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-10 w-10"
                            fill="currentColor"
                    ...
                    <a href="https://www.github.com/anubhav1433" className="text-blue-800 hover:translate-y-[-10px]">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-10 w-10"
                            fill="currentColor"
